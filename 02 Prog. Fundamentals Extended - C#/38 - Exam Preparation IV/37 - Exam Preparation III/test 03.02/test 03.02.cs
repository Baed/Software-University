...
namespace test_03._02
{
    ...
    class FootballLeague
    {
        ...
        {
            var standingsTable = new Dictionary<string, Team>();
            ...
            while (input != "final")
            {
                ...
                string firstTeam = Reverse(match.Groups["teamA"].Value).ToUpper();
                string secondTeam = Reverse(match.Groups["teamB"].Value).ToUpper();
