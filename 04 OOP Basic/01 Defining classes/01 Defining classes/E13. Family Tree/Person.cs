...
public class Person
{
    ...
    public string Name { get; set; } // zas6toto ne e qsno ot kakvi danni 6te e vhoda i nqma field units

    public string BirthDate { get; set; } // zas6toto ne e qsno ot kakvi danni 6te e vhoda i nqma field units
